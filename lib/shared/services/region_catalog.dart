...
class RegionCatalog {
  ...
  List<MapRegion> get all => const [
        ...
        MapRegion(
          ...
          approxSizeBytes: 1393 * 1024 * 1024,
        ...
        MapRegion(
          ...
          approxSizeBytes: 1726 * 1024 * 1024,
        ...
        MapRegion(
          ...
          approxSizeBytes: 1893 * 1024 * 1024,
        ...
        MapRegion(
          ...
          approxSizeBytes: 1815 * 1024 * 1024,
